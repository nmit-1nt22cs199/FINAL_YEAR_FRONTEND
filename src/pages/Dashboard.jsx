      ...
      <main className="p-6 md:p-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          {[
            ...
            <div
              key={i}
              className="group relative bg-gradient-to-br from-slate-900 to-slate-800 border border-cyan-500/30 rounded-lg p-6 hover:border-cyan-400/60 transition-all duration-300"
            >
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1 ml-4">Monitor and manage all vehicles in real-time</p>
            </div>
            <div className="flex gap-2">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium text-sm transition-all duration-300 ${filter === btn.id
          ...
          {/* Fleet Stats Bar */}
          <div className="bg-gradient-to-r from-slate-900/50 to-slate-800/50 border border-cyan-500/20 rounded-lg p-4 mb-6 backdrop-blur-sm">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-green-400">{vehicles.filter(v => v.fuel >= 50 && v.temperature <= 85).length}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-yellow-400">{vehicles.filter(v => (v.fuel >= 30 && v.fuel < 50) || (v.temperature > 85 && v.temperature <= 100)).length}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-red-400">{vehicles.filter(v => v.fuel < 30 || v.temperature > 100).length}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <div
              key={i}
              className="bg-gradient-to-br from-slate-900 to-slate-800 border border-cyan-500/30 rounded-lg p-6 hover:border-cyan-400/60 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/20"
            >
              <div className="flex items-center justify-between mb-2">
